...
class LocalizationManager: ObservableObject {
    ...
    private static let strings: [String: [String: String]] = [
        "en": [
            ...
            "usage.apiUsage": "Anthropic Session Usage",
            "usage.connected": "Connected",
            "usage.logout": "Logout",
            "usage.login": "Login",
            "usage.loginDescription": "Login to see session usage",
            "usage.loggingIn": "Logging in...",
            "usage.loginSuccess": "Login successful",
            "usage.loginFailed": "Login failed",
            "usage.retry": "Retry",
            "usage.cliNotFound": "Claude CLI not found",
            "usage.noCredentials": "Not logged in",
            "usage.authFailed": "Auth failed",
            "usage.fiveHour": "5-hour session",
            "usage.sevenDay": "7-day usage",
            "usage.resetsIn": "resets in",
            "usage.fetching": "Syncing...",
            "usage.synced": "Synced",
        ...
        "ko": [
            ...
            "settings.displayMode": "표시 모드",
            "settings.displayTokens": "토큰",
            "settings.displayPercentage": "세션 사용량",
            "usage.apiUsage": "Anthropic 세션 사용량",
            "usage.connected": "연결됨",
            "usage.logout": "로그아웃",
            "usage.login": "로그인",
            "usage.loginDescription": "세션 사용량을 확인하려면 로그인하세요",
            "usage.loggingIn": "로그인 중...",
            "usage.loginSuccess": "로그인 성공",
            "usage.loginFailed": "로그인 실패",
            "usage.retry": "재시도",
            "usage.cliNotFound": "Claude CLI를 찾을 수 없음",
            "usage.noCredentials": "로그인되지 않음",
            "usage.authFailed": "인증 실패",
            "usage.fiveHour": "5시간 세션",
            "usage.sevenDay": "7일 사용량",
            "usage.resetsIn": "초기화까지",
            "usage.fetching": "동기화 중...",
            "usage.synced": "동기화됨",
            "action.cancel": "취소",
        ],
    ]
