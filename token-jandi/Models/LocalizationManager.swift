...
class LocalizationManager: ObservableObject {
    ...
    private static let strings: [String: [String: String]] = [
        "en": [
            ...
            "action.refreshing": "Refreshing data",
            "action.quit": "Quit",
            "loading.title": "Checking data",
            "loading.message": "Checking Claude and Codex logs.",
            "menuBar.today": "Today",
            "menuBar.thisWeek": "This week",
            "menuBar.claudeToday": "Claude today",
            "menuBar.codexToday": "Codex today",
            "menuBar.iconOnly": "Icon only",
            "settings.menuBarUsage": "Menu bar display",
        ...
        "ko": [
            ...
            "action.quit": "종료",
            "loading.title": "데이터 확인 중",
            "loading.message": "Claude와 Codex 로그를 확인하고 있습니다.",
            "menuBar.today": "오늘",
            "menuBar.thisWeek": "이번 주",
            "menuBar.claudeToday": "Claude 오늘",
            "menuBar.codexToday": "Codex 오늘",
            "menuBar.iconOnly": "아이콘만",
            "settings.menuBarUsage": "메뉴바 표시",
